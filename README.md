...
- macOS 状态栏托盘应用，无主窗口
- 标准本机控制接口，可由 skhd、Hammerspoon、脚本或其他外部工具触发开始/停止/切换
